...
Every source handler (adobe_handler.py, salesforce_handler.py, etc.) imports from here.
Transformation logic lives in the source-specific handler; plumbing lives here.
"""
